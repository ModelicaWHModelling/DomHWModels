...
package TanklessWaterHeater "A model for non-condensing tankless water heaters"
  ...
  model NonCondensingTanklessHeaterValidation
    ...
    Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(
      ...
      columns=2:12,
      fileName=
          "/home/peter/WaterHeaterModeling/modeling/branches/pgrant/TanklessWaterHeater/TanklessValidationNREL.txt")
...
Rate Control")}),                               Diagram(graphics));
  ...
  package Examples
    ...
    package BaseClasses "Base Classes used specifically in example files"
    end BaseClasses;
  end Examples;
  annotation (uses(
