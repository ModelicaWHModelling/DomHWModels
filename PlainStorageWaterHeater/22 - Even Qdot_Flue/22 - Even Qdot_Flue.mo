...
package WaterHeaterLib
  ...
  model WaterHeater "model of a gas water heater without burner"
    ...
    parameter Modelica.SIunits.Temperature T_Initial[nSeg] = {61+273.105,60.74+273.105,60.25+273.105,59.75+273.105,59.3+273.105,59+273.105,58+273.105,57.75+273.15,57.47+273.105,57.4+273.105,57.3+273.105,57.28+273.105,57.28+273.105,57.28+273.105,57.28+273.105,57.23+273.105,57.20+273.105,57.16+273.105,57.13+273.105,57.12+273.105};
...
First implementation.
  ...
  package Examples
    ...
    model WaterHeater "Test model for water heater"
      ...
      Modelica.Blocks.Sources.Constant QBurner(k=10550) annotation (Placement(
      ...
      Modelica.Blocks.Sources.Constant T_switch(k=273.15 + 50)
    ...
    equation
      ...
      connect(TRadMea.y, tan.TRadMea)  annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(tan.heaPor[15], T_sensor.port) annotation (Line(
          points={{28.3377,85.3946},{46,85.3946},{46,-11},{62,-11}},
          color={191,0,0},
          smooth=Smooth.None));
