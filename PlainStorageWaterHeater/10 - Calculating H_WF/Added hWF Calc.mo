...
package WaterHeaterLib
  ...
  public
    ...
    WaterHeaterLib.BaseClasses.buoHeaTra buoHeaTra(
      ...
      m_flow_C=c_sr*m_flow_sr)                     annotation (Placement(
          ...
          rotation=180,
          origin={-495,65})));
    WaterHeaterLib.BaseClasses.h_WF h_WF(
      nSeg=nSeg,
      FlueDiameter=DFlu,
      FlueLength=LFlu,
      redeclare package Medium = Medium) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={-199,169})));
    Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor TWat[nSeg]
      annotation (Placement(transformation(
          extent={{-14,-14},{14,14}},
          rotation=180,
          origin={-122,186})));
    Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor TFluWal[nSeg]
      annotation (Placement(transformation(
          extent={{-15,-15},{15,15}},
          rotation=90,
          origin={-131,123})));
  ...
  equation
    ...
    connect(vol[nSeg].heatPort, buoHeaTra.TWatBot) annotation (Line(
        ...
        color={191,0,0},
        smooth=Smooth.None));
    connect(flueWall.opa_a, TFluWal.port) annotation (Line(
        points={{-118,19},{-124,19},{-124,108},{-131,108}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(TFluWal.T, h_WF.T_W) annotation (Line(
        points={{-131,138},{-130,138},{-130,152.2},{-173.8,152.2}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(TWat.T, h_WF.T_F) annotation (Line(
        points={{-136,186},{-154.9,186},{-154.9,185.8},{-173.8,185.8}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(vol.heatPort, TWat.port) annotation (Line(
        points={{34,20},{-24,20},{-24,86},{-90,86},{-90,186},{-108,186}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(h_WF.h_WF, buoHeaTra.hWatFlu) annotation (Line(
        points={{-222.94,169},{-386,169},{-386,75.6},{-431.4,75.6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(h_WF.h_WF, gain2.u) annotation (Line(
        points={{-222.94,169},{-258,169},{-258,272},{-222,272}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (
  ...
  package Examples
    ...
    equation
      ...
      connect(T_sensor.T, onOffController.u) annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(tan.heaPor[9], T_sensor.port) annotation (Line(
          points={{28.3377,85.958},{28.3377,36.1902},{62,36.1902},{62,-11}},
          color={191,0,0},
          smooth=Smooth.None));
      annotation (
...
First implementation.
    ...
    equation
      ...
      connect(TWat, buoFlu.T_vol) annotation (Line(
          points={{-106,-42},{-86,-42},{-86,-41.6},{-92.2,-41.6}},
          color={191,0,0},
          smooth=Smooth.None));
      ...
      connect(buoFlu.m_flow_buo, dH_BU.mDotFlu) annotation (Line(
          points={{-69,-36},{-6,-36},{-6,-26},{-6,-26},{-6,-22},{4,-22},{4,-16}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(buoFlu.t_h, dH_BU.THotFlu) annotation (Line(
          points={{-69,-42},{-2,-42},{-2,-32},{-2,-32},{-2,-26},{-2,-26},{-2,-24},{4,
              -24},{4,-20}},
          color={0,0,127},
          smooth=Smooth.None));
