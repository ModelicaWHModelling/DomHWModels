...
First implementation.
    ...
    algorithm
      ...
      for i in 2:(nSeg - 1) loop
          dH_BU_B[i] :=mDotBas*c_p*(THotBas - TWat[i])*Buildings.Utilities.Math.Functions.smoothHeaviside(THotBas - TWat[i],smoDel)*Buildings.Utilities.Math.Functions.smoothHeaviside(TWat[i - 1]
           - THotBas, smoDel);
