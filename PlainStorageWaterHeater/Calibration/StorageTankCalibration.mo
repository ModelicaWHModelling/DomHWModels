...
package WaterHeaterLib
  ...
  model WaterHeater "model of a gas water heater without burner"
    ...
    parameter Medium.Temperature T_start=273.15+43 "Start value of temperature"
  ...
  public
    parameter Buildings.Rooms.BaseClasses.ParameterConstruction datFlueWall(
      ...
      T_a_start=316.15) "Data for partition construction"
  ...
  //   Modelica.SIunits.HeatFlowRate Q_flow_WB "Heat flow rate from the base";
    ...
    Modelica.Blocks.Interfaces.RealVectorInput m_flow_in       annotation (
  ...
  //       1].T;
    ...
    connect(heaFluWat.fluid, vol.heatPort)   annotation (Line(
        ...
        color={191,0,0},
        smooth=Smooth.None));
    connect(convTopAmb.solid, tanTop.opa_b)   annotation (Line(
        points={{-44,314},{-44,240},{-0.666667,240},{-0.666667,232.187}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(radTopAmb.port, tanTop.opa_b)            annotation (Line(
        points={{41.26,301.48},{41.26,240},{-0.666667,240},{-0.666667,232.187}},
        color={191,0,0},
        smooth=Smooth.None));
    ...
    connect(h_WF.y, buoHeaTra.hWatFlu) annotation (Line(
        points={{-318,272},{-294,272},{-294,163.6},{66.4,163.6}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    connect(h_cw_B.y, buoHeaTra.hBas) annotation (Line(
        points={{-387.6,-50},{-384,-50},{-384,178},{82,178},{82,163.6},{84.76,163.6}},
        color={0,0,127},
        smooth=Smooth.None));

    connect(heatFlowSensor1.Q_flow, buoHeaTra.QDotFlu) annotation (Line(
        points={{-93,32},{-88,32},{-88,163.6},{58.12,163.6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(buoHeaTra.QDotBas, heatFlowSensor.Q_flow) annotation (Line(
        points={{76.48,163.6},{76.48,166},{20,166},{20,-136},{-10,-136},{-10,-152}},
        color={0,0,127},
        smooth=Smooth.None));

    connect(buoHeaTra.TWatBot, vol[nSeg].heatPort) annotation (Line(
        points={{80.8,161.08},{80.8,172},{108,172},{108,88},{52,88},{52,20},{82,
            20}},
        color={191,0,0},
        smooth=Smooth.None));

    connect(buoHeaTra.TWat, vol.heatPort) annotation (Line(
        points={{62.44,161.08},{-34,161.08},{-34,62},{-12,62},{-12,20},{82,20}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(m_flow_in, replicator.u) annotation (Line(
        points={{-158,464},{-158,440},{-158,440}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(replicator.y, draHeaTra.mFloIn) annotation (Line(
        points={{-158,417},{-158,407.8},{-158,398.6},{-159.4,398.6}},
        color={0,0,127},
        smooth=Smooth.None));
                                                                annotation (
...
volumes in series.
    ...
    model WaterHeaterCalibration "Test model for water heater"
      import WaterHeaterLib;
      extends Modelica.Icons.Example;
      import Modelica.SIunits;
      package Medium = Modelica.Media.Water.WaterIF97_ph "Medium model";
      ...
      Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(
        ...
        tableName="tab1",
        fileName=
            "C:/Program Files (x86)/Dymola 2012 FD01/Models/WaterHeater/current/modeling/branches/pgrant/PlainStorageWaterHeater/StorageTankCharacterizationInputsWaterAndAmbient.txt",
        columns=2:3)
        annotation (Placement(transformation(extent={{-108,68},{-88,88}})));

      Modelica.Blocks.Math.Sum sum1(nin=4)
        annotation (Placement(transformation(extent={{108,86},{128,106}})));
      Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperatureSensor[
        4] annotation (Placement(transformation(extent={{62,86},{82,106}})));
      ...
      Modelica.Blocks.Math.Add add3(k2=-1)
        annotation (Placement(transformation(extent={{104,-4},{124,18}})));
    ...
    equation
      ...
      connect(realExpression.y, combiTable1Ds.u) annotation (Line(
          points={{-125,78},{-110,78}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[2], burn.TDryBul) annotation (Line(
          points={{-87,78},{-52,78},{-52,0},{-8.195,0},{-8.195,5.50345}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[1], tan.m_flow_in) annotation (Line(
          points={{-87,78},{-52,78},{-52,136.429},{-22.1019,136.429}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[2], tan.TDryBul) annotation (Line(
          points={{-87,78},{-52,78},{-52,142},{36,142},{36,100.371},{28.4453,
              100.371}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[2], tan.TRadMea) annotation (Line(
          points={{-87,78},{-52,78},{-52,142},{36,142},{36,66.4585},{27.8,
              66.4585}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(tan.heaPor[1], temperatureSensor[1].port) annotation (Line(
          points={{28.3377,82.3522},{46,82.3522},{46,96},{62,96}},
          color={191,0,0},
          smooth=Smooth.None));
      connect(tan.heaPor[6], temperatureSensor[2].port) annotation (Line(
          points={{28.3377,84.6059},{46,84.6059},{46,96},{62,96}},
          color={191,0,0},
          smooth=Smooth.None));
      connect(tan.heaPor[9], temperatureSensor[3].port) annotation (Line(
          points={{28.3377,85.958},{48,85.958},{48,96},{62,96}},
          color={191,0,0},
          smooth=Smooth.None));
      connect(tan.heaPor[10], temperatureSensor[4].port) annotation (Line(
          points={{28.3377,86.4088},{48,86.4088},{48,96},{62,96}},
          color={191,0,0},
          smooth=Smooth.None));
      connect(temperatureSensor[1].T, sum1.u[1]) annotation (Line(
          points={{82,96},{94,96},{94,94.5},{106,94.5}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[2].T, sum1.u[2]) annotation (Line(
          points={{82,96},{94,96},{94,95.5},{106,95.5}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[3].T, sum1.u[3]) annotation (Line(
          points={{82,96},{94,96},{94,96.5},{106,96.5}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[4].T, sum1.u[4]) annotation (Line(
          points={{82,96},{94,96},{94,97.5},{106,97.5}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(add1.y, sum2.u[1]) annotation (Line(
          points={{127,66},{134,66},{134,38.6667},{142,38.6667}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(add2.y, sum2.u[2]) annotation (Line(
          points={{127,40},{142,40}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(add3.y, sum2.u[3]) annotation (Line(
          points={{125,7},{134,7},{134,41.3333},{142,41.3333}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[1].T, add1.u1) annotation (Line(
          points={{82,96},{92,96},{92,72},{104,72}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[2].T, add1.u2) annotation (Line(
          points={{82,96},{92,96},{92,60},{104,60}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[1].T, add2.u1) annotation (Line(
          points={{82,96},{92,96},{92,46},{104,46}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[3].T, add2.u2) annotation (Line(
          points={{82,96},{92,96},{92,34},{104,34}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[1].T, add3.u1) annotation (Line(
          points={{82,96},{92,96},{92,13.6},{102,13.6}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperatureSensor[4].T, add3.u2) annotation (Line(
          points={{82,96},{92,96},{92,0.4},{102,0.4}},
          color={0,0,127},
          smooth=Smooth.None));
      annotation (
...
First implementation.
    ...
    model buoHeaTra
      ...
      parameter Modelica.SIunits.Area AFlu = 1;
      parameter Real c_wI=1/2;
    ...
    equation
      ...
      connect(qBuo.buoHeaTra, buoHeaTra) annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(QDotBas, qBuo.QBas) annotation (Line(
          points={{-120,36},{16,36},{16,18},{32,18}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(QDotFlu, qBuo.QFlu) annotation (Line(
          points={{-120,-66},{32,-66},{32,-2}},
          color={0,0,127},
          smooth=Smooth.None));
    ...
    equation
      for i in 2:(nSeg - 1) loop
        buoHeaTra[i] =  dHBU[i] + c_p*mDotD[i - 1]*(TWat[i - 1] - TWat[i]) + c_p*m_flow_C*(TWat[i - 1] - TWat[i]) - c_p*m_flow_C*(TWat[i] - TWat[i + 1]) + QFlu[i] - c_p * mDotD[i] * (TWat[i] - TWat[i+1]);
      end for;
      ...
      buoHeaTra[1] =  dHBU[1] - c_p*m_flow_C*(TWat[1] - TWat[2]) + QFlu[1] - c_p * mDotD[1] * (TWat[1] - TWat[2]);
      ...
      buoHeaTra[nSeg] =  dHBU[nSeg] + c_p*m_flow_C*(TWat[nSeg-1] - TWat[nSeg]) + mDotD[nSeg-1] * c_p * (TWat[nSeg-1] - TWat[nSeg]) + QFlu[nSeg] + QBas;
      a = c_p*m_flow_C*(TWat[nSeg-1] - TWat[nSeg]);
      b = mDotD[nSeg-1] * c_p * (TWat[nSeg-1] - TWat[nSeg]);
    ...
    package Burner
      ...
      //    EA=EA,
        ...
        Modelica.Blocks.Sources.RealExpression realExpression(y=0.5)
          annotation (Placement(transformation(extent={{-258,-52},{-238,-32}})));
      equation
        ...
        connect(realExpression.y, T_AD_flame.EA) annotation (Line(
            points={{-237,-42},{-123,-42},{-123,-64}},
            color={0,0,127},
            smooth=Smooth.None));
        annotation (
