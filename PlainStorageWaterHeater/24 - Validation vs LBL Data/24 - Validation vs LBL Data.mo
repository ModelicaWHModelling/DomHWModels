...
package WaterHeaterLib
  ...
  model WaterHeater "model of a gas water heater without burner"
    ...
    parameter Modelica.SIunits.Temperature T_Initial[nSeg] = {273.105 + 55.38,273.105 + 55.38,273.105 + 55.38,273.105 + 55.67,273.105 + 55.67,273.105 + 55.67,273.105 + 55.64,273.105 + 55.64,273.105 + 55.64,273.105 + 55.68,273.105 + 55.68,273.105 + 55.68,273.105 + 55.68,273.105 + 55.68,273.105 + 55.71,273.105 + 55.71,273.105 + 55.71,273.105 + 55.70,273.105 + 55.71,273.105 + 55.75};
  ...
  //  Modelica.SIunits.Temperature T_start;
    ...
    parameter Real topMix = 15
      "Segment at the top of the zone which mixes during a draw";
    parameter Real mDotMix = 0.3
      "Mass flow rate in kg/s of the zone which mixes during a draw";
  ...
  public
    parameter Buildings.Rooms.BaseClasses.ParameterConstruction datFlueWall(
      ...
      each azi=0,
      T_a_start=328.15,
      T_b_start=328.15) "Data for partition construction"
...
First implementation.
  ...
  package Examples
    ...
    //  parameter Real InitialTemp = Modelica.Utilities.Examples.readRealParameter("StorageExampleParameters.txt", "T_Initial");
      ...
      parameter Integer topMix = WaterHeaterLib.BaseClasses.readIntegerParameter("StorageExampleParameters.txt", "topMix");
    //  parameter Integer ThermostatHeight = WaterHeaterLib.BaseClasses.readIntegerParameter("StorageExampleParameters.txt", "ThermostatHeight");
      ...
      Modelica.Blocks.Sources.Constant QBurner(k=Q_Burner)
                                                        annotation (Placement(
      ...
      Modelica.Blocks.Sources.Constant T_switch(k=273.105 + 47)
      ...
      Modelica.Blocks.Sources.Constant QPilot(k=100) annotation (Placement(
    ...
    equation
      ...
      connect(TRadMea.y, tan.TRadMea)  annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(tan.heaPor[17], T_sensor.port) annotation (Line(
      ...
      connect(T_sensor.T, onOffController.u) annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(Time.y, combiTable1Ds.u)           annotation (Line(
      ...
      connect(combiTable1Ds.y[1], tan.m_flow_in) annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(Time[1].y, combiTable1Ds1.u) annotation (Line(
          points={{-133,136},{-124,136},{-124,106},{-114,106}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(Time[1].y, combiTable1Ds2.u) annotation (Line(
          points={{-133,136},{-124,136},{-124,74},{-114,74}},
          color={0,0,127},
          smooth=Smooth.None));
      annotation (
...
First implementation.
    ...
    model buoHeaTra
      ...
      WaterHeaterLib.BaseClasses.strLay
            strLay(nSeg=nSeg) annotation (Placement(transformation(extent={{-66,26},
                {-46,46}})));
...
First implementation.
    ...
    equation
      ...
      for i in 1:(nSeg-1) loop
        ...
        strLay[nSeg-i] = min(1,Buildings.Utilities.Math.Functions.smoothHeaviside(TWat[nSeg-i] - TWat[nSeg-i+1] - 2 * smoDel, smoDel) + Buildings.Utilities.Math.Functions.smoothHeaviside(strLay[nSeg-i+1]-0.1,smoDel));
    ...
    equation
      ...
      for i in 1:(nSeg-1) loop
        QIn[i] = heaPerSeg * Buildings.Utilities.Math.Functions.smoothHeaviside(0.01 - (TWat[i] - TWat[i+1]) - smoDel, smoDel) + QDotFlu[i] * Buildings.Utilities.Math.Functions.smoothHeaviside(TWat[i] - TWat[i+1] - 0.01 - smoDel, smoDel);
      end for;
