...
First implementation.
  ...
  //  Modelica.SIunits.Temperature T_start;
    ...
    parameter Real EffTan = 0.75 "Recovery efficiency of the storage tank";
    ...
    Modelica.Blocks.Math.Gain Eff(k=EffTan)
      annotation (Placement(transformation(extent={{-394,350},{-374,370}})));
  equation
    ...
    connect(vol.heatPort, buoHeaTraMod.TWat) annotation (Line(
        ...
        color={191,0,0},
        smooth=Smooth.None));
    connect(QDotIn, Eff.u) annotation (Line(
        points={{-458,360},{-396,360}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(Eff.y, QPerFlu.u) annotation (Line(
        points={{-373,360},{-348,360},{-348,370},{-332,370}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(Eff.y, QPerBas.u) annotation (Line(
        points={{-373,360},{-346,360},{-346,334},{-326,334}},
        color={0,0,127},
        smooth=Smooth.None));
                                                                annotation (
        Placement(transformation(extent={{322,444},{362,484}}),
...
volumes in series.
    ...
    model SimplifiedStorageTankExample
      ...
      SimplifiedStorageTank tan(
        ...
        QDotPilot=158,
        TSet=273.105 + 46,
        T_Initial={321.215,321.215,321.215,320.07,320.07,320.07,319.906,319.906,
            319.906,319.853,319.853,319.853,319.853,319.724,319.724,319.724,
            319.665,319.506,319.506,318.405},
        UA=5.5)
...
First implementation.
    ...
    package Examples
      ...
      model buoHeaTraModExample "An example using the buoHeaTraMod model"
        ...
        Buildings.Fluid.MixingVolumes.MixingVolume vol[nSeg](redeclare package
            Medium =
              Water, V=0.014,
