...
First implementation.
    ...
    equation
      ...
      for i in 1:(nSeg-1) loop
        ...
        strLay[nSeg-i] = min(1,Buildings.Utilities.Math.Functions.smoothHeaviside(TWat[nSeg-i] - TWat[nSeg-i+1] - smoDel, smoDel) + Buildings.Utilities.Math.Functions.smoothHeaviside(strLay[nSeg-i+1]-0.1,smoDel));
