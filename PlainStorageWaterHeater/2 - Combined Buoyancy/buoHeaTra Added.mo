...
First implementation.
    ...
    model buoHeaTra
      ...
      Modelica.Blocks.Interfaces.RealOutput mFloBas
        "Buoyant mass flow caused by heat transfer through the base"
        annotation (Placement(transformation(extent={{100,64},{120,84}})));
      Modelica.Blocks.Interfaces.RealOutput mFloFlu[nSeg]
        "Buoyant mass flow rate caused by heat transfer through the flue"
        annotation (Placement(transformation(extent={{100,-40},{120,-20}})));
      Modelica.Blocks.Interfaces.RealOutput THotBas
        "Temperature of the buoyant flow caused by heat transfer through the base"
        annotation (Placement(transformation(extent={{100,40},{120,60}})));
      Modelica.Blocks.Interfaces.RealOutput THotFlu[nSeg]
        "Temperature of buoyant flow caused by heat transfer through the flue"
