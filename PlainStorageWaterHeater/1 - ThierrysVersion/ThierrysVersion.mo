...
package WaterHeaterLib
  ...
  protected
    ...
    Modelica.SIunits.HeatFlowRate Q_flow_tot[nSeg]
  ...
  public
    ...
    Modelica.Blocks.Sources.RealExpression h_WF[nSeg](y=h_WF_cons)
  ...
  public
    ...
    Modelica.Blocks.Sources.RealExpression heaCoe[nSeg](y=2)
  ...
  equation
    ...
    connect(buo_F.T_vol, vol.heatPort) annotation (Line(
        ...
        color={191,0,0},
        smooth=Smooth.None));
    connect(buo_F.h, h_WF.y) annotation (Line(
        points={{-325.3,202.2},{-280,202.2},{-280,272},{-318,272}},
        color={0,0,127},
        smooth=Smooth.None));
