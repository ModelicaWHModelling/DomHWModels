...
package WaterHeaterLib
  ...
  //   Modelica.SIunits.HeatFlowRate Q_flow_WB "Heat flow rate from the base";
    ...
    parameter Modelica.SIunits.MassFlowRate TIn = 273.15 + 15;
    Real smoDel = 0.00001;
    ...
    Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heaPor[nSeg]
      "Heat port for sensor" annotation (Placement(transformation(extent={{638,
              -158},{656,-140}},rotation=0), iconTransformation(extent={{306,-42},
              {348,0}})));
  ...
  public
    ...
    Modelica.Blocks.Interfaces.RealInput mDotDra[nSeg]
      "Represents the flow rate of a hot water draw" annotation (Placement(
          transformation(
          extent={{-32,-32},{32,32}},
          rotation=0,
          origin={-452,420})));
    WaterHeaterLib.BaseClasses.draHeaTra draHeaTra(
      ...
      nSeg=nSeg,
      TIn=TIn)
      annotation (Placement(transformation(extent={{-308,380},{-258,430}})));
    ...
    Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow
      prescribedHeatFlow1[nSeg] annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=180,
          origin={82,-98})));
  ...
  equation
    ...
    connect(draHea.y, prescribedHeatFlow1.Q_flow) annotation (Line(
        points={{136.6,-99},{115.3,-99},{115.3,-98},{92,-98}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(prescribedHeatFlow1.port, vol.heatPort) annotation (Line(
        points={{72,-98},{34,-98},{34,20}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(mDotDra, draHeaTra.mDotDra) annotation (Line(
        points={{-452,420},{-313,420}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(vol.heatPort, temperatureSensor.port) annotation (Line(
        points={{34,20},{6,20},{6,18},{-30,18},{-30,212},{-58,212},{-58,292},{
            -80,292},{-80,337},{-210,337}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(temperatureSensor.T, draHeaTra.TWat) annotation (Line(
        points={{-252,337},{-296,337},{-296,338},{-342,338},{-342,390},{-313,
            390}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (
...
First implementation.
  ...
  package Examples
    ...
    model WaterHeater "Test model for water heater"
      ...
      Modelica.Blocks.Sources.Constant mDotDra[nSeg](k=0.02)
        "Represents the flow rate of a hot water draw"
    ...
    equation
      ...
      connect(T_sensor.T, onOffController.u) annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(mDotDra.y, tan.mDotDra) annotation (Line(
          points={{-115,132},{-85.2208,132},{-85.2208,131.707},{-55.4415,
              131.707}},
          color={0,0,127},
          smooth=Smooth.None));
      annotation (
...
First implementation.
    ...
    model draHeaTra "Calculates the thermal impacts of a hot water draw"
      extends Modelica.Blocks.Interfaces.BlockIcon;
      replaceable package Medium = Modelica.Media.Interfaces.PartialMedium;
    ...
    equation
      ...
      for i in 1:(nSeg - 1) loop
         draHeaTra[i] = mDotDra[i] * c_p * (TWat[i] - TWat[i+1]);
       end for;
      ...
      draHeaTra[nSeg] = mDotDra[nSeg] * c_p * (TWat[nSeg] - TIn);
