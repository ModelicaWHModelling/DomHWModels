within ;
package TanklessWaterHeater "A model for non-condensing tankless water heaters"
  ...
  model NonCondensingTanklessHeater
    ...
    parameter Real PID_k_input = 0.405891;
    parameter Real PID_I_input = 47597.1;
    parameter Real PID_D_input = 35.3539;
  ...
  equation
    ...
    connect(InletTemperature, nonCondensingTanklessHXController.T_Inlet)
      annotation (Line(
        points={{-120,8},{-78,8},{-78,-100},{-1.45455,-100}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(pwrSig, nonCondensingTanklessHXController.PowerSignal) annotation (
        Line(
        points={{-120,-140},{-80,-140},{-80,-109},{-1.45455,-109}},
        color={0,0,127},
        smooth=Smooth.None));
  ...
  model NonCondensingTanklessHeaterValidation

    HeatExchangers.NonCondensing nonCondensing(
      nNode=10,
      SteadyStateEff=0.83,
      ConductionCoefficient=0.0001,
      Capacitance=18138.9,
      UA=3.8,
      Qdot_Rated=52800,
      T_Set=48.9)
      annotation (Placement(transformation(extent={{-26,-38},{24,24}})));
    Controllers.NonCondensingTanklessHXController
      nonCondensingTanklessHXController(
      SpecificHeat_cons=4190,
      Qdot_Rated_cons=52800,
      SteadyStateEff_cons=0.83,
      PID_y_start=0.000001,
      T_Set_cons=48.9,
      PID_k=0.268192,
      PID_I=30.222,
      PID_D=5.11857,
      mdot_min_cons=0.0434)
      "A controller intended to mimic the control logic used in non-condensing tankless water heaters. Includes logic to avoid firing when the flow rate is too low or the require heat rate is too low. Also includes logic to reduce the flow rate when the required heat rate surpasses the heaters maximum heat rate"
      annotation (Placement(transformation(extent={{0,-112},{34,-82}})));
    ...
    Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(
      ...
      columns=2:12,
      fileName=
          "C:/Program Files (x86)/Dymola 2012 FD01/Models/models/modelica/WaterHeater/current/modeling/branches/pgrant/TanklessWaterHeater/TanklessValidationNREL.txt")
      annotation (Placement(transformation(extent={{-90,46},{-70,66}})));
    Modelica.Blocks.Math.Sum SumNodesExp(nin=6)
      annotation (Placement(transformation(extent={{-42,70},{-22,90}})));
  equation

    connect(nonCondensingTanklessHXController.mdot_water_controlled,
      nonCondensing.mdot_water) annotation (Line(
        points={{35.7309,-88.15},{35.7309,-71.05},{-31,-71.05},{-31,-7}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(nonCondensingTanklessHXController.ControlConstant, nonCondensing.ControlConstant)
      annotation (Line(
        points={{26.4582,-105.7},{38,-105.7},{38,-52},{1,-52},{1,-44.2}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(nonCondensingTanklessHXController.T_out, nonCondensing.T_Out)
      annotation (Line(
        points={{-2.47273,-101.8},{-2.47273,-126},{46,-126},{46,-7},{28.5,-7}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(Time.y, combiTable1Ds1.u)            annotation (Line(
        points={{-97,56},{-92,56}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[1], nonCondensing.T_Inlet) annotation (Line(
        points={{-69,56},{-52,56},{-52,5.4},{-31,5.4}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[10], nonCondensingTanklessHXController.mdot_water)
      annotation (Line(
        points={{-69,56},{-36,56},{-36,-88},{-2.47273,-88}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[1], nonCondensingTanklessHXController.T_Inlet)
      annotation (Line(
        points={{-69,56},{-36,56},{-36,-94},{-2.47273,-94}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[11], nonCondensingTanklessHXController.PowerSignal)
      annotation (Line(
        points={{-69,56},{-36,56},{-36,-107.5},{-2.47273,-107.5}},
        color={0,0,127},
        smooth=Smooth.None));
  //Modelica.Utilities.Streams.print(String(time) + ","  + String(combiTable1Ds1.y[9]) + "," + String(combiTable1Ds1.y[7]), "\\vmware-host\Shared Folders\Documents\Water Heater Modeling (E81923 and EF8706)\Dymola Output Data\TanklessCharacterization.txt");
    connect(combiTable1Ds1.y[2], SumNodesExp.u[1]) annotation (Line(
        points={{-69,56},{-56,56},{-56,78.3333},{-44,78.3333}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[3], SumNodesExp.u[2]) annotation (Line(
        points={{-69,56},{-58,56},{-58,79},{-44,79}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[4], SumNodesExp.u[3]) annotation (Line(
        points={{-69,56},{-57.5,56},{-57.5,79.6667},{-44,79.6667}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[5], SumNodesExp.u[4]) annotation (Line(
        points={{-69,56},{-56,56},{-56,80.3333},{-44,80.3333}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[6], SumNodesExp.u[5]) annotation (Line(
        points={{-69,56},{-56,56},{-56,81},{-44,81}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[7], SumNodesExp.u[6]) annotation (Line(
        points={{-69,56},{-56,56},{-56,81.6667},{-44,81.6667}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[8], nonCondensing.T_amb) annotation (Line(
        points={{-69,56},{-50,56},{-50,17.8},{-31,17.8}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
              -150},{150,150}}),      graphics), Icon(coordinateSystem(
            preserveAspectRatio=true, extent={{-100,-150},{150,150}}),
          graphics={Bitmap(
            extent={{-98,94},{92,-142}},
            imageSource=
                ""
            ...
            fileName=
                "modelica://TanklessWaterHeater/../../../../../../Users/Peter Grant/Pictures/NonCondensingTanklessSchematic.jpg")}));
  end NonCondensingTanklessHeaterValidation;
  ...
  package HeatExchangers
    ...
    model NonCondensing
      ...
      parameter Real SteadyStateEff = 0.82 "Heater efficiency at steady state";
    ...
    //  parameter Real T_Inlet(unit = "C") = 20 "Entering water temperature";
      ...
      Real T_Node[nNode](unit = "C", each start = 20);
      Real a[nNode];
      Real b[nNode];
    ...
    model NonCondensingValidation
      ...
      parameter Real Qdot_Rated(unit = "W") = 55555
        "Rated capacity of the main burner";
    //  parameter Real T_amb(unit = "C") = 20 "Ambient temperature";
      parameter Real SpecificHeat(unit = "J/(kg.C)") = 4190
        "Specific heat of the fluid being heated";
      parameter Real T_Set(unit = "C") = 55
        "Set temperature of the tankless heater";
      Real ControlConstant;
      Real T_Node[nNode](unit = "C", each start = 12);
      Real a[nNode];
      Real b[nNode];
    //  Real Qdot_in(unit = "W");
      Real Qdot_Delivered(unit = "W");
    ...
    ControlConstant = Qin/Qdot_Rated;
    ...
    Q_Stored = Capacitance * sum(T_Node[1:nNode])/nNode;
    AvgTemp = sum(T_Node[1:nNode])/nNode;
    //SumNodes = T_Node[2] + T_Node[3] + T_Node[7] + T_Node[8] + T_Node[9] + T_Node[10];

      annotation (Diagram(graphics), Icon(graphics={Bitmap(extent={{-100,98},{100,-100}},
                fileName="//vmware-host/Shared Folders/Downloads/HeatExchanger.jpg")}));
    end NonCondensingValidation;
  end HeatExchangers;
  ...
  package Controllers
    ...
    // parameter Real T_Inlet(unit = "C") = 15;
      ...
      Modelica.Blocks.Math.Division division
        annotation (Placement(transformation(extent={{-6,-48},{4,-38}})));
      Modelica.Blocks.Math.Division division1
        annotation (Placement(transformation(extent={{-2,-30},{6,-22}})));
    equation
      ...
      connect(PID.y, product3.u2) annotation (Line(
          points={{49,-26},{54,-26},{54,-38},{72,-38}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(product4.y, TOut.Product4) annotation (Line(
          points={{131,-38},{136,-38},{136,-78},{-74,-78},{-74,-38},{-68,-38}},
          color={0,0,127},
          smooth=Smooth.None));

      connect(T_out, TOut.TOut) annotation (Line(
          points={{-120,-32},{-68,-32}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(T_Set.y, TOut.T_set) annotation (Line(
          points={{-77,-14},{-74,-14},{-74,-26},{-68,-26}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(T_Set.y, division1.u2) annotation (Line(
          points={{-77,-14},{-28,-14},{-28,-28.4},{-2.8,-28.4}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(T_Set.y, division1.u1) annotation (Line(
          points={{-77,-14},{-28,-14},{-28,-23.6},{-2.8,-23.6}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(division1.y, PID.u_s) annotation (Line(
          points={{6.4,-26},{26,-26}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(PID.u_m, division.y) annotation (Line(
          points={{38,-38},{38,-43},{4.5,-43}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(TOut.TOutMod, division.u1) annotation (Line(
          points={{-45,-33},{-20,-33},{-20,-40},{-7,-40}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(T_Set.y, division.u2) annotation (Line(
          points={{-77,-14},{-28,-14},{-28,-46},{-7,-46}},
          color={0,0,127},
          smooth=Smooth.None));
      annotation (
...
Rate Control")}),                             Diagram(graphics));
    ...
    model TOutOverwrite
      "Overwrites T_Out to = T_Set when the burner is not firing. Used to avoid integrator windup"
      extends Modelica.Blocks.Interfaces.BlockIcon;
      Real Debug;
      Modelica.Blocks.Interfaces.RealInput T_set
        annotation (Placement(transformation(extent={{-140,60},{-100,100}})));
      Modelica.Blocks.Interfaces.RealInput Product4
        annotation (Placement(transformation(extent={{-140,-60},{-100,-20}})));
      Modelica.Blocks.Interfaces.RealOutput TOutMod
        annotation (Placement(transformation(extent={{100,0},{120,20}})));
      Modelica.Blocks.Interfaces.RealInput TOut
        annotation (Placement(transformation(extent={{-140,0},{-100,40}})));
    equation

    if Product4 > 0.00000000001 then
      TOutMod = TOut;
      Debug = 1;
    else
      TOutMod = T_set;
  ...
  package Examples
    ...
    model CondensingTanklessExample
      ...
      package ThermoFlueGas = ThermoPower.Media.FlueGas;
      package FlueGas = Buildings.Media.PerfectGases.MoistAirUnsaturated;

      parameter Real GasSpecificEnergy(unit="J/kg") = 49*10^6;
      parameter Modelica.SIunits.Temperature TAmb = 273.105 + 20;
      parameter Real AF_ST = 16.2 "Stoichiometric Air/Fuel Ratio";
      parameter Real EA = 0.1 "Excess air (Expressed in decimal form)";
      parameter Real HumidityRatio = 0.007
        "Humidity ratio of the ambient air (kg/kg)";
      parameter Real comChaV = 0.01 "Volume of the combustion chamber";
      parameter Real comChaA = 0.058
        "Internal surface area of the combustion chamber";
      parameter Real comChaH = 50
        "Convection coefficient inside the combustion chamber";
      parameter Real Capacitance = 10000 "Capciatance of the heat exchanger";
      parameter Real FuelLHV = 52000
        "Lower heating value of the combusted fuel";
      parameter Real MaxWaterFlow = 10*0.063
        "Rated water flow rate of water heater";
      parameter Real MaxFlueGasFlow = 0.0207518 "Rated flow rate of flue gas";
      parameter Real WaterPressureDrop = 10
        "Pressure drop on the water side of the heat exchanger -- SEE COMMENTS IN CODE";
        //Is it actually pressure drop? What are units?
      parameter Real FlueGasPressureDrop = 5
        "Pressure drop on the flue gas side of the heat exchanger -- SEE COMMENTS IN CODE";
        //Is it actually pressure drop? What units?
      parameter Real MaxHeatTransferCoefficient = 1000
        "Heat transfer coefficient in the heat exchanger";
        //Find this value through characterization

      //CombiTable: Put mass flow rate in 1
      //CombiTable: Put inlet temp in 2
      //CombiTable: Put power signal in 3

      TanklessWaterHeater.CombustionAnalysis comAna(
        redeclare package Air = Air,
        redeclare package NatGas = NaturalGas,
        comChaV=comChaV,
        comChaA=comChaA,
        comChaH=comChaH,
        Capacitance=Capacitance,
        FuelLHV=FuelLHV,
        redeclare package FlueGas = ThermoFlueGas)
        annotation (Placement(transformation(extent={{92,-116},{112,-96}})));
      inner Modelica.Fluid.System system
        annotation (Placement(transformation(extent={{-130,-26},{-110,-6}})));
      TanklessWaterHeater.MediaConversion mediaConversion(redeclare package
          ThermoFlueGas = ThermoFlueGas, redeclare package BuildingsFlueGas =
            FlueGas)                                      annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={62,46})));
      ...
      Modelica.Blocks.Sources.Constant EAFactor(k=1 + EA)
        annotation (Placement(transformation(extent={{-36,-144},{-16,-124}})));
      ...
      Modelica.Fluid.Sources.Boundary_pT gasOut(
        nPorts=1,
        redeclare package Medium = FlueGas,
        p=101325)
        annotation (Placement(transformation(extent={{-30,36},{-10,56}})));
      Buildings.Fluid.HeatExchangers.WetCoilCounterFlow con(
        redeclare package Medium1 = HeatedFluid,
        redeclare package Medium2 = FlueGas,
        m1_flow_nominal=MaxWaterFlow,
        m2_flow_nominal=MaxFlueGasFlow,
        dp1_nominal=WaterPressureDrop,
        dp2_nominal=FlueGasPressureDrop,
        UA_nominal=MaxHeatTransferCoefficient)
        annotation (Placement(transformation(extent={{4,38},{42,78}})));
      Modelica.Fluid.Sensors.Temperature temperature(redeclare package Medium
          = HeatedFluid)                             annotation (Placement(
            transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-12,102})));
      Modelica.Fluid.Sources.MassFlowSource_T watFlo(
        use_T_in=true,
        redeclare package Medium = HeatedFluid,
        nPorts=1,
        m_flow=0.1,
        use_m_flow_in=true)
        annotation (Placement(transformation(extent={{-30,60},{-10,80}})));
      Modelica.Fluid.Sources.Boundary_pT watOut(redeclare package Medium =
            HeatedFluid, nPorts=1) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={144,70})));
      TanklessWaterHeater.Controllers.NonCondensingTanklessHXController
        nonCondensingTanklessHXController(
        T_Set_cons=60,
        ...
        PID_I=47600,
        PID_D=35.35)
        annotation (Placement(transformation(extent={{-74,76},{-46,96}})));
      ...
      TanklessWaterHeater.KToC kToC annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={-48,114})));
      Modelica.Blocks.Math.Max max annotation (Placement(transformation(
            ...
            rotation=270,
            origin={6,-66})));
      Modelica.Blocks.Sources.RealExpression Small(y=1*10^(-6))
        annotation (Placement(transformation(extent={{-28,-50},{-8,-30}})));
      Buildings.Fluid.HeatExchangers.DryCoilCounterFlow nonCon(
        redeclare package Medium1 = HeatedFluid,
        redeclare package Medium2 = ThermoFlueGas,
        m1_flow_nominal=MaxWaterFlow,
        m2_flow_nominal=MaxFlueGasFlow,
        dp1_nominal=WaterPressureDrop,
        dp2_nominal=FlueGasPressureDrop,
        UA_nominal=MaxHeatTransferCoefficient)
        annotation (Placement(transformation(extent={{82,38},{120,78}})));
    equation
      ...
      connect(const.y,product1. u2) annotation (Line(
          points={{-43,-40},{-40,-40},{-40,-22},{-36,-22}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(multiProduct.y,airFlo. m_flow_in)   annotation (Line(
          points={{37.02,-98},{54,-98}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(airFlo.ports[1], comAna.airIn) annotation (Line(
          points={{74,-106},{82.9,-106},{82.9,-106.4},{91.8,-106.4}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(gasFlo.ports[1], comAna.gasIn) annotation (Line(
          points={{40,-24},{102,-24},{102,-96.2}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(gasOut.ports[1], con.port_b2)      annotation (Line(
          points={{-10,46},{4,46}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(watFlo.ports[1], con.port_a1)    annotation (Line(
          points={{-10,70},{4,70}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(realExpression.y,combiTable1Ds. u) annotation (Line(
          points={{-123,74},{-114,74}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[1],nonCondensingTanklessHXController. mdot_water)
        annotation (Line(
          points={{-91,74},{-86,74},{-86,92},{-76.0364,92}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[2],nonCondensingTanklessHXController. T_Inlet)
        annotation (Line(
          points={{-91,74},{-86,74},{-86,88},{-76.0364,88}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[3],nonCondensingTanklessHXController. PowerSignal)
        annotation (Line(
          points={{-91,74},{-86,74},{-86,79},{-76.0364,79}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(kToC.C,nonCondensingTanklessHXController. T_out) annotation (Line(
          points={{-59,114},{-86,114},{-86,82.8},{-76.0364,82.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(nonCondensingTanklessHXController.mdot_water_controlled, watFlo.m_flow_in)
        annotation (Line(
          points={{-44.5745,91.9},{-32.2873,91.9},{-32.2873,78},{-30,78}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(nonCondensingTanklessHXController.ControlConstant, product.u1)
        annotation (Line(
          points={{-52.2109,80.2},{-42,80.2},{-42,18},{-76,18},{-76,-4},{-72,-4}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(combiTable1Ds.y[2], watFlo.T_in) annotation (Line(
          points={{-91,74},{-32,74}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperature.T, kToC.K) annotation (Line(
          points={{-12,109},{-12,114},{-36,114}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(product1.y, max.u1) annotation (Line(
          points={{-13,-16},{12,-16},{12,-54}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(Small.y, max.u2) annotation (Line(
          points={{-7,-40},{1.77636e-015,-40},{1.77636e-015,-54}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(max.y, multiProduct.u[1]) annotation (Line(
          points={{6,-77},{6,-95.2},{24,-95.2}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(Stoich.y, multiProduct.u[2]) annotation (Line(
          points={{-15,-98},{0,-98},{0,-98},{24,-98}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(EAFactor.y, multiProduct.u[3]) annotation (Line(
          points={{-15,-134},{8,-134},{8,-100.8},{24,-100.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(comAna.gasOut,nonCon. port_a2) annotation (Line(
          points={{112.4,-106.4},{136,-106.4},{136,46},{120,46}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(nonCon.port_b1, watOut.ports[1]) annotation (Line(
          points={{120,70},{134,70}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(nonCon.port_b2, mediaConversion.theIn) annotation (Line(
          points={{82,46},{72,46}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(mediaConversion.buiOut, con.port_a2)    annotation (Line(
          points={{52,46},{42,46}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(con.port_b1, nonCon.port_a1)    annotation (Line(
          points={{42,70},{82,70}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(nonCon.port_b1, temperature.port) annotation (Line(
          points={{120,70},{120,102},{-2,102}},
          color={0,127,255},
          smooth=Smooth.None));
  ...
  model CombustionAnalysis

    replaceable package Air = ThermoPower.Media.Air;
    replaceable package NatGas = TanklessWaterHeater.TanklessNaturalGas;
    replaceable package FlueGas =
        Buildings.Media.PerfectGases.MoistAirUnsaturated;

    parameter Real comChaV = 0.01 "Volume of the combustion chamber, cu. m.";
    parameter Real comChaA = 0.058
      "Internal surface area of the combustion chamber, sq. m.";
    parameter Real comChaH = 50
      "Convection coefficient inside the combustion chamber, J/sq. m. - K";
    parameter Real Capacitance = 10000
      "Capacitance of the metal in the combustion chamber, J/C";
    parameter Real FuelLHV = 52000 "Lower heating value of the combusted fuel";

    TanklessCombustionChamber         comCha(
      V=comChaV,
      S=comChaA,
      Cm=Capacitance,
      HH=FuelLHV,
      ...
      annotation (Placement(transformation(extent={{-22,-24},{22,16}})));
    inner ThermoPower.System system
      annotation (Placement(transformation(extent={{-84,-92},{-64,-72}})));
    Modelica.Fluid.Interfaces.FluidPort_a gasIn(redeclare package Medium =
          NatGas)
      annotation (Placement(transformation(extent={{-24,74},{24,122}})));
    Modelica.Fluid.Interfaces.FluidPort_a airIn(redeclare package Medium = Air)
      annotation (Placement(transformation(extent={{-126,-28},{-78,20}})));
    Modelica.Fluid.Interfaces.FluidPort_b gasOut(redeclare package Medium =
          FlueGas)
      annotation (Placement(transformation(extent={{80,-28},{128,20}})));
  equation
    connect(airIn, comCha.ina) annotation (Line(
        points={{-102,-4},{-22,-4}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(gasIn, comCha.inf) annotation (Line(
        points={{0,98},{0,16}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(gasOut, comCha.out) annotation (Line(
        points={{104,-4},{22,-4}},
        color={0,127,255},
        smooth=Smooth.None));
    annotation (Diagram(graphics));
  end CombustionAnalysis;

  model TanklessCombustionChamber
    extends ThermoPower.Gas.CombustionChamberBase(
    redeclare package Air=ThermoPower.Media.Air "O2, H2O, Ar, N2",
    redeclare package Fuel = TanklessWaterHeater.TanklessNaturalGas
        "N2, CO2, CH4",
  ...
  protected
    ...
    Real NearZero = 1*10^(-6);
    Real smoDel = 0.001;

  equation
    wcomb=Buildings.Utilities.Math.Functions.smoothMax(inf.m_flow*inf_X[3]/Fuel.data[3].MM,NearZero,smoDel)
      "Combustion molar flow rate";
...
<li><i>31 Jan 2005</i>
 ...
 Combustion Chamber model restructured using inheritance.
  ...
  end TanklessCombustionChamber;

  package partialFlueGas
    extends ThermoPower.Media.FlueGas;
...
Specific enthalpy of liquid water is computed from temperature using a polynomial approach. Kept for compatibility reasons, better use <a href=\"modelica://Modelica.Media.Air.MoistAir.enthalpyOfWater\">enthalpyOfWater</a> instead.
  ...
  model KToC "Converts from K to C"
  ...
  equation
    C = Modelica.SIunits.Conversions.to_degC(K);

  end KToC;

  package CondensingFlueGas

     extends Modelica.Media.Interfaces.PartialCondensingGases(
        mediumName="Condensing Flue Gas",
        substanceNames={"Oxygen", "Argon", "Water", "Carbon Dioxide", "Nitrogen"},
       ...
       constant Integer O2=1
      "Index of Oxygen (in substanceNames, massFractions X, etc.)";
       constant Integer Ar=2
      "Index of Argon (in substanceNames, massFractions X, etc.)";
       constant Integer Water=3
      "Index of water (in substanceNames, massFractions X, etc.)";
       constant Integer CO2=4
      "Index of CarbonDioxide (in substanceNames, massFractions X, etc.)";
       constant Integer N2=5
      "Index of Nitrogen (in substanceNames, massFractions X, etc.)";

    constant Modelica.Media.IdealGases.Common.DataRecord Oxygen=
          Modelica.Media.IdealGases.Common.FluidData.O2;
    constant Buildings.Media.PerfectGases.Common.DataRecord Argon=
          Modelica.Media.IdealGases.Common.FluidData.Ar;
    constant Buildings.Media.PerfectGases.Common.DataRecord H2O=
          Modelica.Media.IdealGases.Common.FluidData.H2O;
    constant Buildings.Media.PerfectGases.Common.DataRecord CarbonDioxide=
          Modelica.Media.IdealGases.Common.FluidData.CO2;
    constant Buildings.Media.PerfectGases.Common.DataRecord Nitrogen=
          Modelica.Media.IdealGases.Common.FluidData.N2;

    constant SI.MolarMass dryair = 0.23 * Oxygen.MM + 0.02 * Argon.MM + 0.04 * CarbonDioxide.MM + 0.7 * Nitrogen.MM;
    constant SI.MolarMass dryaircp = 0.23 * Oxygen.cp + 0.02 * Argon.cp + 0.04 * CarbonDioxide.cp + 0.7 * Nitrogen.cp;
    constant Real k_mair "ratio of molar weights";
    ...
    protected
       constant Modelica.SIunits.MolarMass[5] MMX = {Oxygen.MM,Argon.MM,H2O.MM,CarbonDioxide.MM,Nitrogen.MM}
        "Molar masses of components";

     //  MassFraction X_liquid "Mass fraction of liquid water. Need to be zero.";
       MassFraction X_H2O "Mass fraction of H2O water";
       MassFraction X_air "Mass fraction of air";
       MassFraction X_sat
        "H2O water mass fraction of saturation boundary in kg_water/kg_moistair";
       MassFraction x_sat
        "H2O water mass content of saturation boundary in kg_water/kg_dryair";
       AbsolutePressure p_H2O_sat "Partial saturation pressure of H2O";

     equation
       k_mair =  H2O.MM/dryair;
 ...
 required from medium model \""       + mediumName + "\".");
   ...
   assert(Xi[Water] < X_sat/(1 + x_sat), "The medium model '" + mediumName + "' must not be saturated.\n"
      ...
      + " p         = " + String(p));
 */
       MM = 1/(Xi[3]/MMX[3]+(1.0-Xi[3])/dryair);

       p_H2O_sat = min(saturationPressure(T),0.999*p);
       X_sat = min(p_H2O_sat * k_mair/max(100*Modelica.Constants.eps, p - p_H2O_sat)*(1 - Xi[3]), 1.0)
     ...
     //  X_liquid = max(Xi[Water] - X_sat, 0.0);
       ...
       //     R = dryair.R*(1 - X_H2O) + H2O.R*X_H2O;
       //
       u = h - R*T;
       d = p/(R*T);
       /* Note, u and d are computed under the assumption that the volume of the liquid
          water is neglible with respect to the volume of air and of H2O
       */
       state.p = p;
       state.T = T;
       state.X = X;

       // this x_H2O is water load / dry air!!!!!!!!!!!
       x_sat    = k_mair*p_H2O_sat/max(100*Modelica.Constants.eps,p - p_H2O_sat);
       x_water = Xi[3]/max(X_air,100*Modelica.Constants.eps);
       phi = p/p_H2O_sat*Xi[3]/(Xi[3] + k_mair*X_air);
     end BaseProperties;
  //
 ...
 Derivative function of <a href=Modelica:Modelica.Media.Air.MoistAir.saturationPressureLiquid>saturationPressureLiquid</a>
   ...
   redeclare function enthalpyOfCondensingGas
      "Enthalpy of H2O per unit mass of H2O"
     extends Modelica.Icons.Function;

     input Temperature T "temperature";
     output SpecificEnthalpy h "H2O enthalpy";
   algorithm
     h := (T-273.15) * H2O.cp + enthalpyOfVaporization(T);
     annotation(smoothOrder=5, derivative=der_enthalpyOfCondensingGas);
   end enthalpyOfCondensingGas;

   replaceable function der_enthalpyOfCondensingGas
      "Derivative of enthalpy of H2O per unit mass of H2O"
     extends Modelica.Icons.Function;
     input Temperature T "temperature";
     input Real der_T "temperature derivative";
     output Real der_h "derivative of H2O enthalpy";
   algorithm
     der_h := H2O.cp*der_T;
   end der_enthalpyOfCondensingGas;

   redeclare function enthalpyOfNonCondensingGas
      "Enthalpy of non-condensing gas per unit mass of H2O"
     extends Modelica.Icons.Function;
   ...
   replaceable function der_enthalpyOfNonCondensingGas
      "Derivative of enthalpy of non-condensing gas per unit mass of H2O"
     extends Modelica.Icons.Function;
     input Temperature T "temperature";
     input Real der_T "temperature derivative";
     output Real der_h "derivative of H2O enthalpy";
   ...
   algorithm
     der_h := dryaircp*der_T;
   end der_enthalpyOfDryAir;

   redeclare replaceable function extends specificHeatCapacityCp
      "Specific heat capacity of gas mixture at constant pressure"
   algorithm
     cp := dryaircp*(1-state.X[Water]) +H2O.cp*state.X[Water];
   ...
   algorithm
     der_cp := (H2O.cp-dryaircp)*der_state.X[Water];
   end der_specificHeatCapacityCp;

   redeclare replaceable function extends specificHeatCapacityCv
      "Specific heat capacity of gas mixture at constant volume"
   algorithm
     cv:= dryair.cv*(1-state.X[Water]) +H2O.cv*state.X[Water];
   ...
   algorithm
     der_cv := (H2O.cv-dryair.cv)*der_state.X[Water];
   ...
   function h_pTX
    ...
    protected
     SI.AbsolutePressure p_H2O_sat "Partial saturation pressure of H2O";
     SI.MassFraction x_sat "H2O water mass fraction of saturation boundary";
     SI.SpecificEnthalpy hDryAir "Enthalpy of dry air";
   algorithm
     p_H2O_sat :=saturationPressure(T);
     x_sat    :=k_mair*p_H2O_sat/(p - p_H2O_sat);
     /*
   assert(X[Water] < x_sat/(1 + x_sat), "The medium model '" + mediumName + "' must not be saturated.\n"
      ...
      + " p         = " + String(p));
   */
     hDryAir := (T - 273.15)*dryaircp;
     h := hDryAir * (1 - X[Water]) +
          ((T-273.15) * H2O.cp + 2501014.5) * X[Water];
     annotation(Inline=false,smoothOrder=5);
   end h_pTX;
   ...
   algorithm
     T := 273.15 + (h - 2501014.5 * X[Water])/((1 - X[Water])*dryaircp + X[Water] * H2O.cp);
 ...
 is independent of the pressure.
  ...
  end CondensingFlueGas;

  package TanklessNaturalGas

    extends ThermoPower.Media.NaturalGas(
      fluidConstants={Modelica.Media.IdealGases.Common.FluidData.N2,
                      Modelica.Media.IdealGases.Common.FluidData.CO2,
                      Modelica.Media.IdealGases.Common.FluidData.CH4});

  end TanklessNaturalGas;

  model TanklessCombustionChamber2
    extends ThermoPower.Gas.CombustionChamberBase(
    redeclare package Air=ThermoPower.Media.Air "O2, H2O, Ar, N2",
    redeclare package Fuel = TanklessWaterHeater.TanklessNaturalGas
        "N2, CO2, CH4",
    redeclare package Exhaust =
          Buildings.Media.PerfectGases.MoistAirUnsaturated "Water, Air");
    Real wcomb(final quantity="MolarFlowRate", unit="mol/s")
      "Molar Combustion rate (CH4)";
    Real lambda
      "Stoichiometric ratio (>1 if air flow is greater than stoichiometric)";

  //      Modelica.SIunits.MolarMass MM_O2 = Modelica.Media.IdealGases.Common.SingleGasesData.O2.MM;
       Modelica.SIunits.MolarMass MM_H2O = Modelica.Media.IdealGases.Common.SingleGasesData.H2O.MM;
  //      Modelica.SIunits.MolarMass MM_CO2 = Modelica.Media.IdealGases.Common.SingleGasesData.CO2.MM;
  //      Modelica.SIunits.MolarMass MM_N2 = Modelica.Media.IdealGases.Common.SingleGasesData.N2.MM;
  ...
  equation
    ...
    lambda= (ina.m_flow*ina_X[1]/Air.data[1].MM) / (2 * wcomb);
    assert(lambda >=1, "Not enough oxygen flow");
  //  der(MX[1])=ina.m_flow*ina_X[1] + out.m_flow*fluegas.X[1] - 2*wcomb*MM_O2 "oxygen";
  //  der(MX[2])=ina.m_flow*ina_X[3] + out.m_flow*fluegas.X[2] "argon";
    der(MX[1])=ina.m_flow*ina_X[2] + out.m_flow*fluegas.X[1] + 2*wcomb*MM_H2O "water";
  //  der(MX[4])=inf.m_flow*inf_X[2] + out.m_flow*fluegas.X[4] + wcomb*MM_CO2
  //    "carbondioxide";
  //  der(MX[5])=ina.m_flow*ina_X[4] + out.m_flow*fluegas.X[5] + inf.m_flow*inf_X[1]
  //    "nitrogen";
  //    der(MX[2])=(ina.m_flow*ina_X[1] + out.m_flow*fluegas.X[1] - 2*wcomb*MM_O2) + (ina.m_flow*ina_X[3] + out.m_flow*fluegas.X[2]) + (inf.m_flow*inf_X[2] + out.m_flow*fluegas.X[4] + wcomb*MM_CO2) + (ina.m_flow*ina_X[4] + out.m_flow*fluegas.X[5] + inf.m_flow*inf_X[1]);
  //  der(MX[2]) = -MX[1];
    annotation (Icon(graphics),
                      Documentation(info="<html>
This model extends the CombustionChamber Base model, with the definition of the gases.
...
<li><i>31 Jan 2005</i>
 ...
 Combustion Chamber model restructured using inheritance.
  ...
  end TanklessCombustionChamber2;
  ...
  model MediaConversion
    ...
    Modelica.SIunits.Temperature theT;

    Modelica.Fluid.Interfaces.FluidPort_a theIn(redeclare package Medium =
          ThermoFlueGas)
      annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
    Modelica.Fluid.Interfaces.FluidPort_b buiOut(redeclare package Medium =
          BuildingsFlueGas)
      annotation (Placement(transformation(extent={{90,-10},{110,10}})));
  //initial equation
  //  assert((ThermoFlueGas.X_names[3]) == "water", "xxx");
  equation
    theIn.p = buiOut.p;
    theIn.m_flow + buiOut.m_flow = 0;

    theT = ThermoFlueGas.temperature(ThermoFlueGas.setState_phX(
        theIn.p,
        theIn.h_outflow,
        theIn.Xi_outflow));

    buiOut.h_outflow = BuildingsFlueGas.specificEnthalpy(BuildingsFlueGas.setState_pTX(
        buiOut.p,
        theT,
        buiOut.Xi_outflow));

    buiOut.Xi_outflow[1] = theIn.Xi_outflow[3];
    theIn.Xi_outflow[3] = inStream(buiOut.Xi_outflow[1]);
    theIn.Xi_outflow[1] = 0.23*(1-inStream(buiOut.Xi_outflow[1]));
    theIn.Xi_outflow[2] = 0.02 * (1-inStream(buiOut.Xi_outflow[1]));
    theIn.Xi_outflow[4] = 0.04 * (1-inStream(buiOut.Xi_outflow[1]));
    theIn.Xi_outflow[5] = 0.7 * (1-inStream(buiOut.Xi_outflow[1]));

  //  theIn.C_outflow = ThermoFlueGas.C_nominal;
  //  buiOut.C_outflow = BuildingsFlueGas.C_nominal;
  ...
  model MediaConversionExample

    package ThermoFlueGas = ThermoPower.Media.FlueGas;
    package FlueGas = Buildings.Media.PerfectGases.MoistAirUnsaturated;

    MediaConversion mediaConversion(redeclare package ThermoFlueGas =
          ThermoFlueGas, redeclare package BuildingsFlueGas = FlueGas)
      annotation (Placement(transformation(extent={{-10,-2},{10,18}})));
    Modelica.Fluid.Sources.MassFlowSource_h boundary(nPorts=1,
      redeclare package Medium = ThermoFlueGas,
      m_flow=0.5,
      h=5000)
    ...
    Modelica.Fluid.Sources.Boundary_pT boundary1(nPorts=1, redeclare package
      ...
      p=101325)           annotation (Placement(transformation(
          ...
          origin={50,8})));
  equation
    connect(boundary.ports[1], mediaConversion.theIn) annotation (Line(
        points={{-38,8},{-10,8}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(boundary1.ports[1], mediaConversion.buiOut) annotation (Line(
        points={{40,8},{24,8},{24,8},{10,8}},
        color={0,127,255},
        smooth=Smooth.None));
    annotation (Diagram(graphics));
  end MediaConversionExample;
end TanklessWaterHeater;
