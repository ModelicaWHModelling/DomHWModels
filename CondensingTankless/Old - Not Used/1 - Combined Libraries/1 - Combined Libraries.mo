  ...
  equation
    connect(nonCondensingTanklessHXController.mdot_water_controlled,
      HeatExchanger.mdot_water) annotation (Line(
        points={{20.8727,-96.1},{20.8727,-71.05},{-31,-71.05},{-31,3}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    equation
      ...
      connect(combiTable1Ds.y[2], nonCondensingTanklessHXController.T_Inlet)
        annotation (Line(
          ...
          color={0,0,127},
          smooth=Smooth.None));
      connect(temperature.T, nonCondensingTanklessHXController.T_out) annotation (
          Line(
          points={{88,81},{88,84},{-20,84},{-20,57.2},{-14.0364,57.2}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(nonCondensingTanklessHXController.mdot_water_controlled, watFlo.m_flow_in)
                             annotation (Line(
          points={{17.2218,65.9},{26,65.9},{26,50},{38,50}},
          color={0,0,127},
          smooth=Smooth.None));
