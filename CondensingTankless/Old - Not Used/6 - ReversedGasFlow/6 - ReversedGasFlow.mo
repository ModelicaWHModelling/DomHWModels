...
Rate Control")}),                             Diagram(graphics));
  ...
  package Examples
    ...
    equation
      ...
      connect(nonCon.port_b1, watOut.ports[1]) annotation (Line(
          ...
          color={0,127,255},
          smooth=Smooth.None));
      connect(nonCon.port_b2, mediaConversion.port_a) annotation (Line(
          points={{82,46},{72,46}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(mediaConversion.port_b, con.port_a2)    annotation (Line(
          points={{52,46},{42,46}},
          color={0,127,255},
          smooth=Smooth.None));
  ...
  equation
    ...
    der(MX[3])=ina.m_flow*ina_X[2] + out.m_flow*fluegas.X[3] + 2*wcomb*MM_H2O "water";
