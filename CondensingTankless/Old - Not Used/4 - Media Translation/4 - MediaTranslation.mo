...
Rate Control")}),                             Diagram(graphics));
  ...
  package Examples
    ...
    model CondensingTanklessExample
      ...
      package Air = ThermoPower.Media.Air;//Modelica.Media.Air.MoistAir;
      ...
      Modelica.Fluid.Sources.MassFlowSource_T airFlo(
        ...
        annotation (Placement(transformation(extent={{58,-84},{78,-64}})));
      ...
      Modelica.Blocks.Sources.Constant EAFactor(k=1 + EA)
        annotation (Placement(transformation(extent={{-32,-112},{-12,-92}})));
      Modelica.Blocks.Math.MultiProduct multiProduct(nu=3)
        annotation (Placement(transformation(extent={{28,-72},{40,-60}})));
      ...
      Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(redeclare
          package Medium1 =
                    HeatedFluid, redeclare package Medium2 = FlueGas,
        ...
        annotation (Placement(transformation(extent={{78,10},{116,50}})));
      ...
      Modelica.Fluid.Sources.Boundary_pT watOut(
        nPorts=1,
    ...
    equation
      ...
      connect(const.y, product1.u2) annotation (Line(
          points={{-39,-40},{-36,-40},{-36,-22},{-32,-22}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(product1.y, multiProduct.u[1]) annotation (Line(
          points={{-9,-16},{4,-16},{4,-63.2},{28,-63.2}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(EAFactor.y, multiProduct.u[3]) annotation (Line(
          points={{-11,-102},{4,-102},{4,-68.8},{28,-68.8}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(multiProduct.y, airFlo.m_flow_in)   annotation (Line(
          points={{41.02,-66},{58,-66}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(nonCondensingTanklessHXController.mdot_water_controlled, watFlo.m_flow_in)
                             annotation (Line(
          points={{17.4255,65.9},{26,65.9},{26,50},{38,50}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(watFlo.T_in, combiTable1Ds.y[2])    annotation (Line(
          points={{36,46},{4,46},{4,48},{-29,48}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(cooCoi.port_b1, temperature.port) annotation (Line(
          points={{116,42},{116,74},{98,74}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(watFlo.ports[1], cooCoi.port_a1)    annotation (Line(
          ...
          color={0,127,255},
          smooth=Smooth.None));
      connect(comAna.gasOut, cooCoi.port_a2)             annotation (Line(
          points={{112.4,-74.4},{118,-74.4},{118,-74},{124,-74},{124,18},{116,18}},
          color={0,127,255},
          smooth=Smooth.None));

      connect(gasFlo.ports[1], comAna.gasIn) annotation (Line(
          points={{44,-24},{102,-24},{102,-64.2}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(airFlo.ports[1], comAna.airIn) annotation (Line(
          points={{78,-74},{84.9,-74},{84.9,-74.4},{91.8,-74.4}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(watOut.ports[1], cooCoi.port_b2)   annotation (Line(
          points={{50,18},{78,18}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(temperature.T, kToC.K) annotation (Line(
          points={{88,81},{88,88},{26,88}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(kToC.C, nonCondensingTanklessHXController.T_out) annotation (Line(
          points={{3,88},{-24,88},{-24,56.8},{-14.0364,56.8}},
          color={0,0,127},
          smooth=Smooth.None));
