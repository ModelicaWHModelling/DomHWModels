...
package TanklessWaterHeater "A model for non-condensing tankless water heaters"
  ...
  equation
    ...
    connect(nonCondensingTanklessHXController.T_out,HeatExchanger. T_Out)
      annotation (Line(
        points={{-1.45455,-104.8},{-1.45455,-124},{40,-124},{40,3},{28.5,3}},
        color={0,0,127},
        smooth=Smooth.None));
  ...
  model NonCondensingTanklessHeaterValidation
    ...
    Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(
      ...
      columns=2:12,
      fileName=
          "C:/Program Files (x86)/Dymola 2012 FD01/Models/WaterHeater/current/modeling/branches/pgrant/TanklessWaterHeater/TanklessCharacterizationNREL.txt")
  ...
  equation
    ...
    connect(nonCondensingTanklessHXController.mdot_water_controlled,
      nonCondensing.mdot_water) annotation (Line(
        points={{35.4836,-88.15},{35.4836,-71.05},{-31,-71.05},{-31,-7}},
        color={0,0,127},
        smooth=Smooth.None));
    ...
    connect(nonCondensingTanklessHXController.T_out, nonCondensing.T_Out)
      annotation (Line(
        points={{-2.47273,-101.2},{-2.47273,-126},{46,-126},{46,-7},{28.5,-7}},
        color={0,0,127},
        smooth=Smooth.None));
  ...
  model NonCondensingHXValidation
    ...
    Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(
      ...
      tableName="tab1",
      columns=2:12,
      fileName="C:/Program Files (x86)/Dymola 2012 FD01/Models/models/modelica/TanklessWaterHeater/TanklessCharacterizationNREL.txt")
      annotation (Placement(transformation(extent={{-90,46},{-70,66}})));
    Modelica.Blocks.Math.Sum SumNodesExp(nin=6)
      annotation (Placement(transformation(extent={{-42,70},{-22,90}})));
    HeatExchangers.NonCondensingValidation nonCondensingValidation(Capacitance=
          15961, SteadyStateEff=0.83)
      annotation (Placement(transformation(extent={{-10,-26},{38,26}})));
  equation
    ...
    connect(combiTable1Ds1.y[7], SumNodesExp.u[6]) annotation (Line(
        ...
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[9], nonCondensingValidation.Qin) annotation (Line(
        points={{-69,56},{-42,56},{-42,-10.4},{-14.8,-10.4}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[1], nonCondensingValidation.T_Inlet) annotation (
        Line(
        points={{-69,56},{-42,56},{-42,10.4},{-14.8,10.4}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[8], nonCondensingValidation.T_amb) annotation (
        Line(
        points={{-69,56},{-42,56},{-42,20.8},{-14.8,20.8}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(combiTable1Ds1.y[10], nonCondensingValidation.mdot_water)
      annotation (Line(
        points={{-69,56},{-42,56},{-42,0},{-14.8,0}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
              -150},{150,150}}),      graphics), Icon(coordinateSystem(
...
Rate Control")}),                             Diagram(graphics));
  ...
  model NonCondensingTanklessHeaterValidationTesting

  equation
  //  DataFiles.readCSVmatrix("DataReadTest.csv");
    annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
          ...
          graphics={Bitmap(
            ...
            fileName=
                "modelica://TanklessWaterHeater/../../../../../../Users/Peter Grant/Pictures/NonCondensingTanklessSchematic.jpg")}));
  end NonCondensingTanklessHeaterValidationTesting;
  ...
  package Examples
    ...
    equation
      ...
      connect(kToC.C, nonCondensingTanklessHXController.T_out) annotation (Line(
          points={{3,88},{-24,88},{-24,57.2},{-14.0364,57.2}},
          color={0,0,127},
          smooth=Smooth.None));
