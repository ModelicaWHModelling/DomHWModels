...
Rate Control")}),                             Diagram(graphics));
  ...
  package Examples
    ...
    model CondensingTanklessExample
      ...
      package NaturalGas = ThermoPower.Media.NaturalGas;
      package Air = ThermoPower.Media.Air;//Modelica.Media.Air.MoistAir;
      package FlueGas = TanklessWaterHeater.FlueGas;
      ...
      Modelica.Fluid.Sources.MassFlowSource_T gasFlo(
        ...
        T=TAmb,
        nPorts=1,
        X={1})    annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=0,
            origin={34,-24})));
    ...
    equation
      ...
      connect(airFlo.ports[1], comAna.airIn) annotation (Line(
          ...
          color={0,127,255},
          smooth=Smooth.None));
      connect(boundary.ports[1], cooCoi.port_b2) annotation (Line(
          points={{50,18},{78,18}},
          color={0,127,255},
          smooth=Smooth.None));
  ...
  model CombustionAnalysis
    ...
    replaceable package NatGas = ThermoPower.Media.NaturalGas;
    replaceable package FlueGas = TanklessWaterHeater.FlueGas;
  ...
  model TanklessCombustionChamber
    ...
    redeclare package Exhaust =
          TanklessWaterHeater.FlueGas "O2, Ar, H2O, CO2, N2");
