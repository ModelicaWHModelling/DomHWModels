...
Rate Control")}),                             Diagram(graphics));
  ...
  package Examples
    ...
    model CondensingTanklessExample
      ...
      TanklessWaterHeater.CombustionInputs combustionInputs(
        TAmb=TAmb,
        GasSpecificEnergy=GasSpecificEnergy,
        EA=EA,
        AF_ST=AF_ST)
        annotation (Placement(transformation(extent={{30,-68},{50,-48}})));
      TanklessWaterHeater.cooCoi cooCoi(
        MaxWaterFlow=MaxWaterFlow,
        MaxFlueGasFlow=MaxFlueGasFlow,
        WaterPressureDrop=WaterPressureDrop,
        FlueGasPressureDrop=FlueGasPressureDrop,
        MaxHeatTransferCoefficient=MaxHeatTransferCoefficient)
        annotation (Placement(transformation(extent={{82,30},{102,50}})));
      TanklessWaterHeater.InputsAndController inputsAndController
        annotation (Placement(transformation(extent={{-10,32},{10,52}})));
    equation

      connect(combustionInputs.gasOut, comAna.gasIn) annotation (Line(
          points={{50.2,-56},{102,-56},{102,-64.2}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(combustionInputs.airOut, comAna.airIn) annotation (Line(
          points={{50.2,-61},{70,-61},{70,-74.4},{91.8,-74.4}},
          color={0,127,255},
          smooth=Smooth.None));
      connect(cooCoi.port_a1, comAna.gasOut) annotation (Line(
          points={{102,37},{114,37},{114,36},{122,36},{122,-74.4},{112.4,-74.4}},
          color={0,127,255},
          smooth=Smooth.None));

      connect(cooCoi.y, inputsAndController.TOut) annotation (Line(
          points={{103,46},{106,46},{106,68},{-26,68},{-26,48},{-12,48}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(inputsAndController.ControlSignal, combustionInputs.ControlSignal)
        annotation (Line(
          points={{11,38},{18,38},{18,-52},{28,-52}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(cooCoi.mFlow, inputsAndController.mFlo) annotation (Line(
          points={{80,42},{46,42},{46,44.6},{11,44.6}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(inputsAndController.TIn, cooCoi.TIn) annotation (Line(
          points={{11,42.4},{40,42.4},{40,38.4},{80,38.4}},
          color={0,0,127},
          smooth=Smooth.None));
  ...
  model CombustionAnalysis
    ...
    TanklessCombustionChamber2        comCha(
      V=comChaV,
      S=comChaA,
      Cm=Capacitance,
      HH=FuelLHV,
  ...
  model TanklessCombustionChamber
    ...
    redeclare package Fuel = TanklessWaterHeater.TanklessNaturalGas
        "N2, CO2, CH4",
    redeclare package Exhaust = TanklessWaterHeater.CondensingFlueGas
        "O2, Ar, H2O, CO2, N2");
    ...
    Real lambda
      ...
      Modelica.SIunits.MolarMass MM_CO2 = Modelica.Media.IdealGases.Common.SingleGasesData.N2.MM;
...
<li><i>31 Jan 2005</i>
 ...
 Combustion Chamber model restructured using inheritance.
  ...
  model cooCoi
    extends Modelica.Blocks.Interfaces.BlockIcon;
    replaceable package HeatedFluid =
        Modelica.Media.Water.ConstantPropertyLiquidWater;
    replaceable package FlueGas =
        Buildings.Media.PerfectGases.MoistAirUnsaturated;

    parameter Real MaxWaterFlow;
    parameter Real MaxFlueGasFlow;
    parameter Real WaterPressureDrop;
    parameter Real FlueGasPressureDrop;
    parameter Real MaxHeatTransferCoefficient;
    ...
    Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(redeclare package
        Medium1 = HeatedFluid, redeclare package Medium2 = FlueGas,
      ...
      annotation (Placement(transformation(extent={{4,-38},{42,2}})));
    ...
    Modelica.Fluid.Sources.Boundary_pT watOut(redeclare package Medium =
          ...
          origin={82,-6})));
  equation
    connect(gasOut.ports[1],cooCoi. port_b2)   annotation (Line(
        points={{-24,-30},{4,-30}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(cooCoi.port_b1,temperature. port) annotation (Line(
        points={{42,-6},{42,26},{24,26}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(temperature.T, y) annotation (Line(
        points={{14,33},{16,33},{16,60},{110,60}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(cooCoi.port_a2, port_a1) annotation (Line(
        ...
        color={0,127,255},
        smooth=Smooth.None));
    connect(TIn, watFlo.T_in) annotation (Line(
        points={{-120,-16},{-88,-16},{-88,2},{-78,2}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(mFlow, watFlo.m_flow_in) annotation (Line(
        points={{-120,20},{-88,20},{-88,6},{-76,6}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(watFlo.ports[1], cooCoi.port_a1) annotation (Line(
        points={{-56,-2},{-18,-2},{-18,-6},{4,-6}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(watOut.ports[1], cooCoi.port_b1) annotation (Line(
        points={{72,-6},{57,-6},{57,-6},{42,-6}},
        color={0,127,255},
        smooth=Smooth.None));
    annotation (Diagram(graphics));
  end cooCoi;
